 ...
 * fields.
 */
public class ParseException extends SourceError {
    ...
    public ParseException(Token currentTokenVal, int[][] expectedTokenSequencesVal, String[] tokenImageVal) {
        super("ParseError", currentTokenVal.getSourcePoint(), "", StringUtil.EMPTY_STRING_ARRAY);
    ...
    public ParseException() {
        super("ParseError", new SourcePoint("", 0, 0, 0, 0), "", StringUtil.EMPTY_STRING_ARRAY);
    ...
    public String getMessage() {
        ...
        for (int[] expectedTokenSequence : expectedTokenSequences) {
            ...
            for (int anExpectedTokenSequence : expectedTokenSequence) {
                expected += tokenImage[anExpectedTokenSequence] + " ";
            }
